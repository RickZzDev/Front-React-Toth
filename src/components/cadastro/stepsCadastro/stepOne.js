...
function StepOne({status,mudaStatus,guardaDados,mostraJson,value, confereCnpj}){
    return(
            <div>
                <form name="frmformulario" onSubmit={event => {
                    ...
                    <div className="row mb-5">
                        <div className="form-group text-left pl-0 pr-0 col-12">
                            <Input buscaCep={confereCnpj} name="cnpj"  value={value} guardaDados={guardaDados} placeholder="cnpj" />
                        </div>
                    </div>
